...
import com.example.springboot.controller.request.EatPageRequest;
...
public class EatController {
    ...
    public Result uploadFile(MultipartFile file) {
        ...
        try {
            ...
            String url = "http://localhost:9090/api/eat/file/download/" + flag + "?&token=" + token;
    ...
    @PostMapping("/save")
    public Result save(@RequestBody Eat obj) {
        eatService.save(obj);
        return Result.success();
    }

    @PutMapping("/update")
    public Result update(@RequestBody Eat obj) {
        eatService.update(obj);
        return Result.success();
    }
    ...
    public Result getById(@PathVariable Integer id) {
        Eat obj = eatService.getById(id);
        return Result.success(obj);
    }

    @GetMapping("/list")
    public Result list() {
        List<Eat> list = eatService.list();
        return Result.success(list);
    }

    @GetMapping("/page")
    public Result page(EatPageRequest pageRequest) {
        return Result.success(eatService.page(pageRequest));
    }
