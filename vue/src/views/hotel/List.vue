<template>
  <div>
    ...
    <div style="margin: 10px 0 20px 5px">
      ...
      <el-input style="width: 170px" placeholder="请输入房间号" v-model="params.hotelNo"></el-input>
      <el-button style="margin-left: 5px" type="primary" @click="load">
        <i class="el-icon-search" style="margin-right: 4px"></i>搜索
      </el-button>

      <el-button style="margin-left: 5px" type="warning" @click="reset"><i class="el-icon-refresh" style="margin-right: 4px"></i>重置
      </el-button>

    </div>
    <el-table :data = "tableData" stripe row-key="id" default-expand-all>
      <div slot="empty">
        <el-empty description="没有搜索到数据。。。"></el-empty>
      </div>
      ...
      <el-table-column prop="hotelDate" label="发布日期"></el-table-column>
      <el-table-column prop="head" label="负责人"></el-table-column>
      <el-table-column prop="category" width="100" label="种类"></el-table-column>
      <el-table-column prop="hotelNo" label="房间号"></el-table-column>
      <el-table-column prop="score" label="订房积分"></el-table-column>
      ...
      <el-table-column label="操作" width="150">
        <template v-slot="scope">
          ...
          <el-button type="primary" icon="el-icon-edit"
                     @click="$router.push('/editHotel?id=' + scope.row.id)"></el-button>
...
<!--    <div v-if="resCode !='200'"  slot="empty" style="text-align: left;">-->
...
export default {
  ...
  methods: {
    ...
    del(id) {
      request.delete("/hotel/delete/" + id).then(res => {
